    ...
    <div class="page-content clearfix">
        <div id="brand_style">
            ...
            <div class="border clearfix">
                <span class="l_f">
                    <a href="{{Route('ProductManageAdd')}}" title="添加品牌" class="btn btn-warning Order_form"><i class="icon-plus"></i>添加品牌</a>
                        ...
                        <tbody>
                           @foreach ($data['data'] as $v)
                               <tr>
                                    ...
                                    <td><img src="{{$v->thumbnails}}" width="130" /></td>
                                    <td><a href="javascript:;" name="Brand_detailed.html" style="cursor:pointer" class="text-primary brond_name"
                ...
                series: [
                    {
                        ...
                        center: ['50%', '60%'],
                        data: [
                            { value: {{$data['n']}}, name: '国内品牌' },
                            { value: {{$data['w']}}, name: '国外品牌' },
