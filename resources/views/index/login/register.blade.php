...
<body>
	<div class="register py-container ">
		...
		<div class="registerArea">
			...
			<div class="info">
				<form class="sui-form form-horizontal" method="POST" action="{{Route('HomeDoRegister')}}">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" name="phone" placeholder="短信验证码" class="input-xfat input-xlarge">
							<input type="button" onclick="sendCode()" value="获取短信验证码">
						</div>
					</div>
