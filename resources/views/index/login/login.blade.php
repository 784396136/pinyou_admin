				...
				<div class="loginform">
					...
					<div class="tab-content tab-wraped">
						...
						<div id="profile" class="tab-pane  active">
							<form class="sui-form" action="{{Route('HomeDoLogin')}}" method="POST">
								@csrf
								@if (session('error'))
									{{session('error')}}
								@endif
								<div class="input-prepend"><span class="add-on loginname"></span>
									<input id="prependedInput" type="text" name="username" placeholder="用户名/手机号" value="{{old('username')}}" class="span2 input-xfat">
								</div>
								<div class="input-prepend"><span class="add-on loginpwd"></span>
									<input id="prependedInput" name="password" type="password" placeholder="请输入密码" value="{{old('password')}}" class="span2 input-xfat">
								</div>
								<div class="setting">
