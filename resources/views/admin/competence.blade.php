...
<body>
	<div class="margin clearfix">
		<div class="border clearfix">
			<span class="l_f">
				<a href="{{Route('AdmincpAdd')}}" id="Competence_add" class="btn btn-warning" title="添加权限"><i class="fa fa-plus"></i>
					添加权限</a>
				...
				<tbody>
					@foreach ($data as $k)
						<tr>
							...
							<td>
								<a title="编辑" href="{{Route('AdmincpEdit',['id'=>$k->id])}}" class="btn btn-xs btn-info"><i class="fa fa-edit bigger-120"></i></a>
								<a title="删除" href="javascript:;" onclick="Competence_del(this,{{$k->id}})" class="btn btn-xs btn-warning"><i class="fa fa-trash  bigger-120"></i></a>
							</td>
						</tr>
					@endforeach
				</tbody>
...
<script type="text/javascript">
	...
	function Competence_del(obj, id) {
		layer.confirm('确认要删除吗？（该操作不会删除管理员）', function (index) {
			$.ajax({
				type:"GET",
				url:"{{Route('AdmincpDel')}}",
				data:{id:id},
