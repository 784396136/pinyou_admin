...
<body>
	<div class="page-content clearfix">
		...
		<div id="add_administrator_style" class="add_menber" style="display:none">
			<form action="{{ Route('AdminAdd') }}" method="post" id="form-admin-add">
				@csrf
				<div class="form-group">
					<label class="form-label"><span class="c-red">*</span>管理员：</label>
					<div class="formControls">
						<input type="text" class="input-text" value="{{old('name')}}" placeholder="用户名" id="user-name" name="name" datatype="*2-16"
						 nullmsg="用户名不能为空">
					</div>
				...
				<div class="form-group">
					...
					<div class="formControls">
						<input type="password" value="{{old('password')}}" placeholder="密码" name="password" autocomplete="off" value="" class="input-text"
				...
				<div class="form-group">
					...
					<div class="formControls ">
						<input type="password" value="{{old('password_confirmation')}}" placeholder="确认新密码" autocomplete="off" class="input-text Validform_error" errormsg="您两次输入的新密码不一致！"
						 datatype="*" nullmsg="请再输入一次新密码！" recheck="password" id="newpassword2" name="password_confirmation">
					</div>
					<div class="col-4"> <span class="Validform_checktip"></span></div>
				</div>
				<div class="form-group">
