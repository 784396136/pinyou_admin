...
class TestController extends Controller
{
    public function index()
    {
        ...
        // 将订单状态修改为已提交
        $res = Order::where('order_number',201811152105405945761329)->update(['pay_status'=>'1']);
        $order_id = Order::select('id')->where('order_number',201811152105405945761329)->first();
